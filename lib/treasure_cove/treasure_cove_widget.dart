...
class TreasureCoveWidget extends StatefulWidget {
  TreasureCoveWidget({Key key}) : super(key: key);

  @override
  _TreasureCoveWidgetState createState() => _TreasureCoveWidgetState();
}

class _TreasureCoveWidgetState extends State<TreasureCoveWidget> {
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            fit: BoxFit.fitHeight,
            image: Image.asset(
              'assets/images/TreasureChest.jpg',
            ).image,
          ),
        ),
        child: Stack(
