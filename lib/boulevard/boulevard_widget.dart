...
class BoulevardWidget extends StatefulWidget {
  BoulevardWidget({Key key}) : super(key: key);

  @override
  _BoulevardWidgetState createState() => _BoulevardWidgetState();
}

class _BoulevardWidgetState extends State<BoulevardWidget> {
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            fit: BoxFit.fitWidth,
            image: Image.asset(
              'assets/images/BoulevardSquareCropped.webp',
            ).image,
          ),
        ),
        child: Stack(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.fill,
                                image: Image.asset(
                                  'assets/images/YellowFashion.jpg',
                                ).image,
                              ),
                              borderRadius: BorderRadius.circular(8),
                              shape: BoxShape.rectangle,
                              ...
                              onTap: () async {
                                await Navigator.push(
                                  ...
                                  PageTransition(
                                    ...
                                    reverseDuration:
                                        Duration(milliseconds: 300),
                                    child: NavBarPage(initialPage: 'Shopping'),
                                  ),
                                );
                              },
                              child: Column(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: Image.asset(
                                  'assets/images/HealthandFitness.jpg',
                                ).image,
                              ),
                              borderRadius: BorderRadius.circular(8),
                            ),
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: Image.asset(
                                  'assets/images/Golf2Recreation.jpg',
                                ).image,
                              ),
                              borderRadius: BorderRadius.circular(8),
                            ),
